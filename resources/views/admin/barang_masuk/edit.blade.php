    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit Stok Barang</li>
            </ol>
        </nav>
    </div>
    <div class="card">
        <div class="card-body">
            <form action="{{ route('barang-masuk.update', $barangMasuk->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group my-2">
                            ...
                            <input type="text" class="form-control @error('harga_beli') is-invalid @enderror"
                                value="{{ $barangMasuk->harga_beli }}" placeholder="Harga Beli" id="harga_beli"
                                name="harga_beli">
                            @error('harga_beli')
                                <div class="text-danger">
                                    {{ $message }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group my-2">
                            ...
                            <input type="number" class="form-control @error('stok') is-invalid @enderror"
                                value="{{ $barangMasuk->stok }}" placeholder="Stok" id="stok" name="stok">
                            @error('stok')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                ...
                <div class="col d-flex justify-content-center mt-4">
                    <a class="btn btn-warning text-dark me-4" href="{{ route('barang-masuk.index') }}">Kembali</a>
